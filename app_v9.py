...
qty_label = f"Ações em carteira ({sel})"
qty_shares = st.sidebar.number_input(qty_label, min_value=0, max_value=1_000_000, value=0, key="qty_shares")
cash_label = f"Caixa disponível (R$) ({sel})"
cash_avail = st.sidebar.text_input(cash_label, value="10.000,00", key="cash_avail")
